...
import org.gridgain.examples.helloworld.gridify.task.*;
 ...
 * <p>
 * String "Hello World" is set into {@link GridifyHelloWorld} instance
 * as its state. Since method {@link GridifyHelloWorld#sayIt()} is annotated
 * with {@code @Gridify} annotation it is automatically grid-enabled. The
 * {@link GridifyHelloWorldStateTask} task specified in {@link Gridify}
 * annotation will split the state of {@link GridifyHelloWorld} instance into
 * words and send each word as job argument for execution on separate nodes.
 * Jobs on remote nodes will create {@link GridifyHelloWorld} instances and will
...
public final class GridifyHelloWorldStateExample {
     ...
     * Ensure singleton.
     */
    private GridifyHelloWorldStateExample() {
        // No-op.
    }
