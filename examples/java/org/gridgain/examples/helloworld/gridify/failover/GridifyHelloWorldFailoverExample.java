 ...
 * {@code Gridify} annotation and custom grid task. It also
 * shows the usage of failover logic.
 * <p>
 ...
 * {@link GridifyHelloWorldFailoverTask} task responsible for split and
 ...
 * by {@link GridifyHelloWorldFailoverTask#result(GridJobResult, List)} method
...
public final class GridifyHelloWorldFailoverExample {
    ...
    public static void main(String[] args) throws GridException {
        ...
        try {
            ...
            X.println(">>>");
            X.println(">>> Finished executing Gridify \"Hello World\" example with failover.");
