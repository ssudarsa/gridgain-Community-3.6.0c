 ...
 * {@code Gridify} annotation and custom grid task. It also demonstrates usage
 * of task session.
 * <p>
 * String "Hello World" is passed as an argument to
 * {@link #sayIt(String)} method. Since this method is annotated with
 * {@code Gridify} annotation it is automatically grid-enabled. Jobs
 * on each of the participating nodes will do the following:
 * <ol>
 * <li>
 *      Print out their own argument, which in this case will be a single
 *      word from "Hello World" string.
 * </li>
 * <li>
 ...
 * </li>
 * </ol>
 * Note that method {@link #sayIt(String)} is called twice on every node. Once
 * to print out its own argument, and then once again to print out all session
 * attributes. One of the potential outcomes could look as following:
 * <pre class="snippet">
 * >>>
 * >>> Printing 'World' on this node from grid-enabled method.
 * >>>
 * >>>
 * >>> Printing 'All session attributes [ World Hello ]' on this node from grid-enabled method.
 * >>>
 * </pre>
 * <p>
 * Grid task {@link GridifyHelloWorldSessionTask} handles actual splitting
...
public final class GridifyHelloWorldSessionExample {
     ...
     * words to be printed on remote nodes.
     *
    ...
    public static void main(String[] args) throws GridException {
        ...
        try {
            ...
            X.println(">>>");
            X.println(">>> Finished executing Gridify \"Hello World\" example with task session.");
