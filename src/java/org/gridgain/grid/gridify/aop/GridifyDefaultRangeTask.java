...
public class GridifyDefaultRangeTask extends GridTaskAdapter<GridifyRangeArgument, Collection<?>> {
     ...
     * {@inheritDoc}
     */
    @Override public Map<? extends GridJob, GridNode> map(List<GridNode> subgrid, GridifyRangeArgument arg)
        ...
        Collection<GridNode> exclNodes = new LinkedList<GridNode>();
        ...
        while (inputIter.hasNext()) {
            Collection<Object> nodeInput = new LinkedList<Object>();
            ...
            GridJob job = new GridifyJobAdapter(jobArg);
    ...
    /** {@inheritDoc} */
    @Override public final Collection<?> reduce(List<GridJobResult> results) throws GridException {
        assert results.size() >= 1;

        Collection<Object> data = new ArrayList<Object>(results.size());
