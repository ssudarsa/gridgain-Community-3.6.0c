...
public abstract class GridPredicate2<E1, E2> extends GridLambdaAdapter {
     ...
     * @return New closure.
     */
    public <A> GridClosure2<E1, E2, A> andThen(final GridClosure<Boolean, A> c) {
        return new GridClosure2<E1, E2, A>() {
            @Override public A apply(E1 e1, E2 e2) {
                return c.apply(GridPredicate2.this.apply(e1, e2));
            }
        };
    }
     ...
     * @return New closure.
     */
    public GridInClosure2<E1, E2> andThen(final GridInClosure<Boolean> c) {
        return new GridInClosure2<E1, E2>() {
            @Override public void apply(E1 e1, E2 e2) {
                c.apply(GridPredicate2.this.apply(e1, e2));
            }
        };
    }
     ...
     */
    public GridPredicate2<E1, E2> andThen(final GridPredicate<Boolean> c) {
        return new GridPredicate2<E1, E2>() {
