 ...
 * To provide for more terse code you can use a typedef {@link org.gridgain.grid.typedef.CI3} class or various factory methods in
...
public abstract class GridInClosure3<E1, E2, E3> extends GridLambdaAdapter {
     ...
     */
    public GridInClosure2<E2, E3> curry(final E1 e1) {
        return withMeta(new CI2<E2, E3>() {
            {
