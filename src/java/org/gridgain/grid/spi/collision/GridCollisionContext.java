 ...
 * (see {@link GridJobContinuation}), then collection of held jobs will
...
public interface GridCollisionContext {
     ...
     * {@code held} state by calling {@link GridJobContinuation#holdcc()} method at
     * which point job will release all resources and will get suspended. If
     * {@link GridJobContinuation job continuations} are not used, then this list
