...
public class GridS3CheckpointSpi extends GridSpiAdapter implements GridCheckpointSpi, GridS3CheckpointSpiMBean {
    ...
    @Override public void spiStart(String gridName) throws GridSpiException {
        ...
        Collection<GridS3TimeData> s3TimeDataLst = new LinkedList<GridS3TimeData>();
    ...
    @Nullable private GridS3CheckpointData read(String key) throws GridException, AmazonClientException {
        ...
        try {
            ...
            try {
                return U.unmarshal(marsh, in, GridS3CheckpointSpi.class.getClassLoader());
            }
            finally {
                U.closeQuiet(in);
            }
    ...
    private class GridS3TimeoutWorker extends GridSpiThread {
        ...
        private Map<String, GridS3TimeData> map = new HashMap<String, GridS3TimeData>();
        ...
        @Override public void body() throws InterruptedException {
            ...
            Collection<String> rmvKeys = new HashSet<String>();
