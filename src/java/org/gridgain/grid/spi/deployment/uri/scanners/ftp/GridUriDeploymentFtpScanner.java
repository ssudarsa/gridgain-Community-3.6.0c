...
public class GridUriDeploymentFtpScanner extends GridUriDeploymentScanner {
    ...
    @Override protected void process() {
        Collection<GridUriDeploymentFtpFile> foundFiles = new HashSet<GridUriDeploymentFtpFile>(cache.size());
        ...
        if (!isFirstScan()) {
            Collection<GridUriDeploymentFtpFile> delFiles = new HashSet<GridUriDeploymentFtpFile>(cache.keySet());
