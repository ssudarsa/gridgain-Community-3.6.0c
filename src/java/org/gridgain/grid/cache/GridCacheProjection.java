...
public interface GridCacheProjection<K, V> extends Iterable<GridCacheEntry<K, V>>, GridMetadataAware {
     ...
     * @throws GridCacheFlagException If projection flags validation failed.
     */
    public GridFuture<Boolean> putxAsync(K key, V val, @Nullable GridPredicate<? super GridCacheEntry<K,
        V>>... filter);
     ...
     */
    public boolean compact(K key, @Nullable GridPredicate<? super GridCacheEntry<K,
        V>>... filter) throws GridException;
