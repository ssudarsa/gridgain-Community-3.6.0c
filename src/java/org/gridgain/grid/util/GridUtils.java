...
public abstract class GridUtils {
     ...
     */
    public static GridByteArrayList marshal(GridMarshaller marshaller, @Nullable Object obj) throws GridException {
    ...
    public static String toShortString(GridNode n) {
        return "GridNode [id=" + n.id() + ", order=" + n.order() + ", intAddr=" + n.internalAddresses() +
            ", extAddr=" + n.externalAddresses() + ", daemon=" +
            ("true".equalsIgnoreCase(n.<String>attribute(ATTR_DAEMON))) + ']';
    }
