...
public interface GridCacheEntryEx<K, V> extends GridMetadataAware {
     ...
     * @throws GridCacheEntryRemovedException If entry has been removed.
     */
    public T2<Boolean, V> innerSet(@Nullable GridCacheTxEx<K, V> tx, UUID evtNodeId, UUID affNodeId, @Nullable V val,
        @Nullable byte[] valBytes, boolean writeThrough, long expireTime, long ttl, boolean evt,
     ...
     * @throws GridCacheEntryRemovedException If entry has been removed.
     */
    public T2<Boolean, V> innerRemove(@Nullable GridCacheTxEx<K, V> tx, UUID evtNodeId, UUID affNodeId,
