...
public class GridCacheAnnotationHelper<A extends Annotation> {
    ...
    public GridCacheAnnotationHelper(Class<A> annCls, int capacity) {
        ...
        fieldCache = new GridBoundedLinkedHashMap<Class<?>, List<Field>>(capacity);

        mtdCache = new GridBoundedLinkedHashMap<Class<?>, List<Method>>(capacity);
    }
    ...
    public Object annotatedValue(Object target) throws GridException {
        GridTuple2<Object, Boolean> res = annotatedValue(target, new HashSet<Object>(), false);
     ...
     * @throws GridException If failed to find.
     */
    private GridTuple2<Object, Boolean> annotatedValue(Object target, Set<Object> visited, boolean annFound)
        ...
        for (Class<?> cls = target.getClass(); !cls.equals(Object.class); cls = cls.getSuperclass()) {
            ...
            for (Field f : fieldsWithAnnotation(cls)) {
                ...
                if (needsRecursion(f)) {
                    if (fieldVal != null) {
                        // Recursion.
                        GridTuple2<Object, Boolean> tup = annotatedValue(fieldVal, visited, annFound);
