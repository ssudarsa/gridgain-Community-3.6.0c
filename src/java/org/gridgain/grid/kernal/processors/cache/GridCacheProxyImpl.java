...
public class GridCacheProxyImpl<K, V> implements GridCacheProxy<K, V>, Externalizable {
    ...
    /** {@inheritDoc} */
    @Override public GridFuture<Map<K, V>> getAllAsync(@Nullable GridPredicate<? super GridCacheEntry<K,
        V>>[] filter) {
        GridCacheProjectionImpl<K, V> prev = gate.enter(prj);
    ...
    /** {@inheritDoc} */
    @Override public GridFuture<?> inTxAsync(GridInClosure<GridCacheProjection<K,
        V>>[] closures) throws GridException {
        GridCacheProjectionImpl<K, V> prev = gate.enter(prj);
    ...
    /** {@inheritDoc} */
    @Override public void inTx(long timeout, GridInClosure<GridCacheProjection<K,
        V>>[] closures) throws GridException {
        GridCacheProjectionImpl<K, V> prev = gate.enter(prj);
    ...
    /** {@inheritDoc} */
    @Override public <R> GridFuture<Collection<R>> inTxAsync(GridCacheTxConcurrency concurrency,
        GridCacheTxIsolation isolation, long timeout, boolean invalidate, GridOutClosure<? super R>[] closures) throws
        IllegalStateException, GridException {
        GridCacheProjectionImpl<K, V> prev = gate.enter(prj);
    ...
    @Override public GridCacheAtomicSequence atomicSequence(String name) throws GridException {
        ...
        try {
            return cache.atomicSequence(name);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public GridCacheAtomicSequence atomicSequence(String name, long initVal, boolean persistent)
        ...
        try {
            return cache.atomicSequence(name, initVal, persistent);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public boolean removeAtomicSequence(String name) throws GridException {
        ...
        try {
            return cache.removeAtomicSequence(name);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public GridCacheAtomicLong atomicLong(String name, long initVal, boolean persistent) throws
        ...
        try {
            return cache.atomicLong(name, initVal, persistent);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public boolean removeAtomicLong(String name) throws GridException {
        ...
        try {
            return cache.removeAtomicLong(name);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public <T> GridCacheAtomicReference<T> atomicReference(String name) throws GridException {
        ...
        try {
            return cache.atomicReference(name);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public <T> GridCacheAtomicReference<T> atomicReference(String name, T initVal, boolean persistent)
        ...
        try {
            return cache.atomicReference(name, initVal, persistent);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public boolean removeAtomicReference(String name) throws GridException {
        ...
        try {
            return cache.removeAtomicReference(name);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public <T, S> GridCacheAtomicStamped<T, S> atomicStamped(String name) throws GridException {
        ...
        try {
            return cache.atomicStamped(name);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public <T, S> GridCacheAtomicStamped<T, S> atomicStamped(String name, T initVal, S initStamp)
        ...
        try {
            return cache.atomicStamped(name, initVal, initStamp);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public boolean removeAtomicStamped(String name) throws GridException {
        ...
        try {
            return cache.removeAtomicStamped(name);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public boolean removeQueue(String name) throws GridException {
        ...
        try {
            return cache.removeQueue(name, 0);
        }
        finally {
            gate.leave(prev);
        }
    ...
    @Override public boolean removeQueue(String name, int batchSize) throws GridException {
        ...
        try {
            return cache.removeQueue(name, batchSize);
        }
        finally {
            gate.leave(prev);
        }
